                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-3 col-sm-3 col-xs-3">
                                <a href="<?= "request.php?tkn=".$dmo->storeRoute("school/student.php"); ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-success mt-1"><span data-plugin="counterup"><?php $dmo->getStudents(["school_code"=>$dmo->safeData($user['school_code'])])['status']? $count = sizeof($dmo->getStudents(["school_code"=>$dmo->safeData($user['school_code'])])['data']) : $count = 0; echo number_format($count, 0); ?></span></h3>
                            ...
                            <div class="col-xl-3 col-md-3 col-sm-3 col-xs-3">
                                <a href="<?=  "request.php?tkn=".$dmo->storeRoute("school/teacher.php"); ?>">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-success border-success border">
                            ...
                            <div class="col-xl-3 col-md-3 col-sm-3 col-xs-3">
                                <a href="<?=  "request.php?tkn=".$dmo->storeRoute("school/vendor.php"); ?>">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-success border-success border">
                            ...
                            <div class="col-xl-3 col-md-3 col-sm-3 col-xs-3">
                                <a href="<?=  "request.php?tkn=".$dmo->storeRoute("school/visitor.php"); ?>">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-success border-success border">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Visitors</p>
                                            </div>
                                        </div>
                                    </div>
                                </div></a>
