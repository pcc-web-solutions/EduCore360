...
<head>
    <meta charset="utf-8" />
    <title>School || Permission Keys</title>
                    ...
                    <table id="tblcoa" class="table-bordered table-head-fixed table-striped table-responsive text-nowrap">
                        ...
                        foreach ($response['data'] as $row) { ?>
                            <tr>
                                ...
                                <td><a href="<?= "request.php?tkn=".$dmo->storeRoute("school/user_permission.php")."&permission=".$row['permission'] ?>" class="btn btn-xs btn-info"><i class="fas fa-users"></i>&nbsp;Assigned Users</a></td>
                            </tr>
                        <?php $count++; } }?>
                        </tbody>
                    </table>
