<?php require_once __DIR__."/uac.php"; ?>
    ...
    <div class="navbar-custom">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("school/profile.php");?>" class="dropdown-item notify-item">
                        <i class="fe-user"></i>
                        <span>My Profile</span>
                    </a>
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("school/company_profile.php");?>" class="dropdown-item notify-item">
        ...
        <div class="logo-box">
            <a href="<?= "request.php?tkn=".$dmo->storeRoute("school/home.php"); ?>" class="logo text-center">
                <span class="logo-lg">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("school/register_user.php");?>" class="dropdown-item">
