...
<head>
    <meta charset="utf-8" />
    <title>HRM || Support Staffs</title>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-info">
                                    <h4 class="modal-title text-white">New Support Staff</h4>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Set Up Support Staffs </h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-box">  
                        <table id="tblstaff" class="table-bordered table-head-fixed table-striped table-responsive text-nowrap">
                            ...
                            <tbody id="tblstaffs">
                            <?php
                            if($dmo->getSupportStaffs(["school_code"=>$user['school_code']])['status']){
                            $response = $dmo->getSupportStaffs(["school_code"=>$user['school_code']]); $count=1;
                            foreach ($response['data'] as $row) { $id = $dmo->safeData($row['id']); ?>
                                <tr>
                                    <td><?= $count ?></td>
