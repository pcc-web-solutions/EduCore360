<?php require_once __DIR__."/uac.php"; ?>
    ...
    <div class="navbar-custom">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("procurement/profile.php");?>" class="dropdown-item notify-item">
                        <i class="fe-user"></i>
        ...
        <div class="logo-box">
            <a href="<?= "request.php?tkn=".$dmo->storeRoute("procurement/home.php"); ?>" class="logo text-center">
                <span class="logo-lg">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("procurement/register_vendor.php");?>" class="dropdown-item">
                        <i class="fe-users mr-1"></i>
                        <span>Vendor</span>
                    </a>
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("procurement/new_item.php");?>" class="dropdown-item">
                        <i class="mdi mdi-cube mr-1"></i>
                        <span>Item</span>
                    </a>
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("procurement/new_tro.php");?>" class="dropdown-item">
                        <i class="mdi mdi-cart-arrow-right mr-1"></i>
                        <span>Transfer Order</span>
                    </a>
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("procurement/new_pr.php");?>" class="dropdown-item">
                        <i class="fe-shopping-cart mr-1"></i>
                        <span>Purchase Requisition</span>
                    </a>
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("procurement/new_po.php");?>" class="dropdown-item">
