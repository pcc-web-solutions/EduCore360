                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-info">
                                    <h4 class="modal-title text-white">New Staff Member</h4>
                                ...
                                <div class="modal-body">
                                    <form id="frmNewStaff" autocomplete="off" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="school"  class="form-control select2" id="school" onchange='loadSelect("departments", "fetch.php", "department", this)'>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Set Up Staffs </h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-box">  
                        <table id="tblstaff" class="table-bordered table-head-fixed table-striped table-responsive text-nowrap">
                            ...
                            <tbody id="tblstaffs">
                            <?php
                            if($dmo->getStaffs()['status']){
                            $response = $dmo->getStaffs(); $count=1;
                            foreach ($response['data'] as $row) { $id = $dmo->safeData($row['id']); ?>
                                <tr>
