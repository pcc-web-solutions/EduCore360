<?php require_once __DIR__."/uac.php"; ?>
    ...
    <div class="navbar-custom">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("super/profile.php");?>" class="dropdown-item notify-item">
                        <i class="fe-user"></i>
                        <span>My Profile</span>
                    </a>
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("super/company_profile.php");?>" class="dropdown-item notify-item">
        ...
        <div class="logo-box">
            <a href="<?= "request.php?tkn=".$dmo->storeRoute("super/home.php"); ?>" class="logo text-center">
                <span class="logo-lg">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-lg-block d-md-block  d-sm-block">
                <a class="nav-link dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    Register New
                    <i class="mdi mdi-chevron-down"></i> 
                </a>
                <div class="dropdown-menu">
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("super/register_school.php");?>" class="dropdown-item">
                        <i class="fe-users mr-1"></i>
                        <span>School</span>
                    </a>
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("super/register_user.php");?>" class="dropdown-item">
                        <i class="fe-users mr-1"></i>
                        <span>User</span>
                    </a>
                </div>
