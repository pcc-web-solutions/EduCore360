...
-- Generated on: 2025-10-19 10:06:02
...
CREATE TABLE `charge` (
  ...
  `type` enum('Standing','Service','Item','Other') NOT NULL DEFAULT 'Standing',
  `is_recurring` tinyint(1) DEFAULT '0',
  `recurring_type` enum('Yearly','Quarterly','Monthly','Weekly','Daily','Hourly','Per Minute') DEFAULT NULL,
  ...
  `status` enum('Normal','On Offer') DEFAULT 'Normal',
  PRIMARY KEY (`id`),
  KEY `school` (`school`),
...
CREATE TABLE `customer` (
  ...
  `customer_type` enum('Student','Guardian','Staff','Regular') DEFAULT 'Regular',
...
CREATE TABLE `news` (
  ...
  `category` enum('announcement','event','circular','press') DEFAULT 'announcement',
...
CREATE TABLE `subject_preference` (
  ...
  `prefer_period` enum('morning','afternoon') DEFAULT NULL,
...
CREATE TABLE `tax` (
  ...
  `type` enum('VAT','WHT','OTHER') DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `school` (`school`),
...
-- Data for table `user`
INSERT INTO `user` (`id`, `school`, `userid`, `username`, `password`, `displayname`, `role`, `profile`, `email`, `contact`, `photo`, `regdate`, `lastlogindate`, `lastlogintime`, `lastlogoutdate`, `lastlogouttime`, `attempts`, `status`, `session_id`, `created_at`, `updated_at`, `updated_by`) VALUES ('34', '36626205', 'hWbFL', 'pcc', '$2y$12$TJzElX3ahnYnsWLKmMqEXenZEz7N/w0EpGB8oAz4cjLrL0MOyKyTi', 'Musee Abiud', 'sa', 'hrm', 'museeabiud@outlook.com', '0741915943', 'upload/png/user-default-2-min.png', '2025-09-19', '2025-10-19', '06:55:29', '2025-10-18', '08:19:44', '4', '1', 'b8b14b23946a616668c5702dc45ab26e', '2025-09-19 18:55:28', '2025-10-19 07:44:11', NULL);
