<?php require_once __DIR__."/uac.php"; ?>
    ...
    <div class="navbar-custom">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("finance/profile.php");?>" class="dropdown-item notify-item">
                        <i class="fe-user"></i>
        ...
        <div class="logo-box">
            <a href="<?= "request.php?tkn=".$dmo->storeRoute("finance/home.php"); ?>" class="logo text-center">
                <span class="logo-lg">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("finance/register_vendor.php");?>" class="dropdown-item">
                    ...
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("finance/new_tro.php");?>" class="dropdown-item">
