<?php require_once __DIR__."/uac.php"; ?>
    ...
    <div class="navbar-custom">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    <a href="<?= "request.php?tkn=".$dmo->storeRoute("dos/profile.php");?>" class="dropdown-item notify-item">
                        <i class="fe-user"></i>
        ...
        <div class="logo-box">
            <a href="<?= "request.php?tkn=".$dmo->storeRoute("dos/home.php"); ?>" class="logo text-center">
                <span class="logo-lg">
