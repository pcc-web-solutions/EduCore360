                    ...
                    <div class="card-box">  
                        <table id="tblsubject" class="table-bordered table-head-fixed table-striped table-responsive text-nowrap">
                            ...
                            foreach ($response['data'] as $row) { $id = $dmo->safeData($row['id']); ?>
                                <tr>
                                    <td><?= $count ?></td>
                                    <td contentEditable=false onblur='edit("subject","class",<?= $id ?>,this)'><?= $dmo->safeData($row['class_code']." - ".$row['class_name']) ?></td>
                                    ...
                                    <td contentEditable=false onblur='edit("subject","group",<?= $id ?>,this)'><?= $dmo->safeData($row['group_code']." - ".$row['group_name']) ?></td>
                                    <td contentEditable=false onblur='edit("subject","department",<?= $id ?>,this)'><?= $dmo->safeData($row['dept_code']." - ".$row['dept_name']) ?></td>
